        ...
        while True:
            ...
            for f in feeds:
                ...
                if not f.initialized:
                    print(f"Feed: {f.id} is not initialized, adding all articles to database")
                for entry in d.entries:
                    if not f.initialized:
                        ...
                        try:
                            ...
                            print("Found new article, sending to linked webhooks")
                            summary = re.sub('<[^<]+?>', '', entry.summary)
                            data = {
                                    "username": "TechNewsBot",
...
parser_list_link = list_sp.add_parser('link', help='List all links registered with the system')
